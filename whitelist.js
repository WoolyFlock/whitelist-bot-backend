bot.command('start', async (ctx) => {
    ...
    await bot.telegram.sendPhoto(ctx.chat.id, imageUrl, {
      caption: `Hey ${first_name}, our Liquidity Lambs NFT collection is launching in less than 10 hours. You can now check your eligibility for whitelist. Simple Connect wallet to check eligibility.\n\nUnlock exclusive perks, rewards, and a chance to be part of something revolutionary. Limited spots for early sheeps!`,
      reply_markup: {
        inline_keyboard: [
